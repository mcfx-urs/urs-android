...
/** A fixed gram amount of one ingredient, rendered read-only —  has no ratio/quantity scaling for v1. */
...
/**
 * Sourdough Bread, the only template seeded for  v1. Worked out in
 * full in `.tracker/TRACKER.md` () from a 55min bake at 230°C→200°C.
